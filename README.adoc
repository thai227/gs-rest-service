...
`src/main/java/thai/Greeting.java`
[source,java]
----
include::complete/src/main/java/thai/Greeting.java[]
----
...
`src/main/java/thai/GreetingController.java`
[source,java]
----
include::complete/src/main/java/thai/GreetingController.java[]
----
...
`src/main/java/thai/Application.java`
[source,java]
----
include::complete/src/main/java/thai/Application.java[]
----
